...
| FunctionDoesNotExist | Wrong chain_id, or truncated/malformed data | Pass chain_id from transactionRequest.chainId. Ensure data is complete (no truncation). Convert value from hex to decimal. |
